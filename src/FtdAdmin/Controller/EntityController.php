...
namespace FtdAdmin\Controller;

use FtdAdmin\Entities\Entity;
use FtdAdmin\Service\EntityService;
...
class EntityController extends AbstractActionController
{
     ...
     *
     * @return \FtdAdmin\Service\EntityService
     */
     ...
     *
     * @param \FtdAdmin\Service\EntityService $entityService
     */
