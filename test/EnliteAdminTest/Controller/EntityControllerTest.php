...
namespace EnliteAdminTest\Controller;


use EnliteAdmin\Controller\EntityController;
...
class EntityControllerTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function getController(array $mock = [])
    {
        ...
        $this->entityService = $this->getMockBuilder('EnliteAdmin\Service\EntityService')
        ...
        if (count($mock)) {
            $this->object = $this->getMock('EnliteAdmin\Controller\EntityController', $mock);
        } else {
    ...
    protected function getEntity()
    {
        ...
        $entity->setService(
            $this->getMockBuilder('EnliteAdmin\Service\DefaultEntityService')
                ->disableOriginalConstructor()->getMock()
        );
