...
namespace FtdAdminTest\Service;

use FtdAdmin\Entities\Entity;
use FtdAdmin\Entities\EntityOptions;
use FtdAdmin\Service\DefaultEntityService;
use Zend\Form\Form;
...
class DefaultEntityServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFactory()
    {
        ...
        $this->assertInstanceOf('FtdAdminTest\Mock\EntityMock', $service->factory());
    }
    ...
    {
        $service = $this->getMockBuilder('FtdAdmin\Service\DefaultEntityService')
    ...
    public function testGetRepository()
    {
        ...
        $manager->expects($this->once())->method('getRepository')
            ->with('FtdAdminTest\Mock\EntityMock')
    ...
    {
        return new Entity('a', new EntityOptions(['entity' => 'FtdAdminTest\Mock\EntityMock']));
    }
