...
namespace FtdAdminTest\Navigation\Service;

use FtdAdmin\Entities\Container;
use FtdAdmin\Entities\Entity;
use FtdAdmin\Entities\EntityOptions;
use FtdAdmin\Navigation\Service\AdminNavigationFactory;
...
class AdminNavigationFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetPages()
    {
        ...
        $factory = $this->getMock(
            'FtdAdmin\Navigation\Service\AdminNavigationFactory',
    ...
    public function testGetEntitiesPageEmpty()
    {
        ...
        $factory = $this->getMock('FtdAdmin\Navigation\Service\AdminNavigationFactory');
