...
namespace FtdAdminTest\Controller;


use FtdAdmin\Controller\EntityController;
use FtdAdmin\Entities\Entity;
use FtdAdmin\Entities\EntityOptions;
use FtdAdminTest\Mock\EntityMock;
use Zend\Form\Form;
...
class EntityControllerTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function getController(array $mock = [])
    {
        ...
        $this->entityService = $this->getMockBuilder('FtdAdmin\Service\EntityService')
        ...
        if (count($mock)) {
            $this->object = $this->getMock('FtdAdmin\Controller\EntityController', $mock);
        } else {
    ...
    protected function getEntity()
    {
        ...
        $entity->setService(
            $this->getMockBuilder('FtdAdmin\Service\DefaultEntityService')
                ->disableOriginalConstructor()->getMock()
        );
