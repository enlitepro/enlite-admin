...
use FtdAdmin\Entities\ContainerFactory;
...
class ContainerFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCreateService()
    {
        ...
        $this->assertInstanceOf('FtdAdmin\Entities\Container', $container);
        $this->assertCount(1, $container->getEntities());
        $this->assertInstanceOf('FtdAdmin\Entities\Entity', $container->getEntity('user'));
    }
